...
PRODUCTS: list[ProductSpec] = [
    ...
    ProductSpec(
        ...
        spatial_support="gauge_point",  # observed discharge at a physical gauge
        coverage=["CONUS"],
    ...
    ProductSpec(
        ...
        spatial_support="reach",  # modelled discharge for one river reach
        coverage=["global"],
    ...
    ProductSpec(
        ...
        spatial_support="reach",  # GloFAS v4 cell discharge for one channel
        coverage=["global"],
    ...
    ProductSpec(
        ...
        spatial_support="reach",  # GloFAS reanalysis discharge for one cell
        coverage=["global"],
